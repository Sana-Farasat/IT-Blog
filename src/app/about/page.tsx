...
export default function AboutPage() {
  ...
  return (
    <main className="max-w-screen-2xl mx-auto ">
      {/* <div
        className="relative h-screen bg-cover bg-center"  style={{ backgroundImage: "url('/aboutpage-bg.jpg')" }}
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        >
          ...
          tech enthusiast, or working professional. From programming tutorials
          and cybersecurity tips to cloud computing, AI, and industry trends —
          we cover it all.
        </p>
        ...
        >
          ...
          highlight real-world applications, open-source tools, and career
          development tips.
        </p>
